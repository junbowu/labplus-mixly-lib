...
#ifndef Labplus_NEOPIXEL_H
#define Labplus_NEOPIXEL_H
...
// the same item.  The third parameter to the Labplus_NeoPixel
...
class Labplus_NeoPixel {

 public:

  // Constructor: number of LEDs, pin number, LED type
  Labplus_NeoPixel(uint16_t n, uint8_t p=6, neoPixelType t=NEO_GRB + NEO_KHZ800);
  Labplus_NeoPixel(void);
  ~Labplus_NeoPixel();
